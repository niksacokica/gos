gos:AddApp({
	...
	["window"] = function( window )
		...
		local function emailsFill( eType )
			...
			for k, v in ipairs( gos.Emails[eType] ) do
		...
		hook.Add( "gOSEmailNewEmail", "gOSEmailNew", function( eType )
			local child = window:GetChildren()
		...
		net.Receive( "gos_email_details", function( len )
